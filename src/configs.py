...
def hello():
    sticker = random.choice(['CAACAgIAAxkBAAEDQxBhjXzPDr7ckygFQf9V4zEWygU1fgAC5w0AAkwAAalLKPSbhF1cTYkiBA',
...
def misunderstand():
    sticker = random.choice(['CAACAgIAAxkBAAEDQxRhjX3kHeBhgy3A8GUgccjwXwNzLQACUw8AAkcG-EsYhXwrKl3SnCIE',
...
def fail_searching():
    sticker = random.choice(['CAACAgIAAxkBAAEDQxphjYH0KA7LnIf40U0W5VbwovcJVgACShIAApQn0EljczZtGB_D8iIE',
...
def good_search():
    sticker = random.choice(['CAACAgIAAxkBAAEDQyJhjYRSUh0gv-n9SljdbbSZHdjJqQACOQ0AAqef6UitbBViw4Y2WyIE',
...
def wait():
    sticker = random.choice(['CAACAgIAAxkBAAEDQzhhjYqDNsmQTwnKCRlb-fcAAdV09DQAAl0OAAI7YKBLdQ2NqtLq9qAiBA',
